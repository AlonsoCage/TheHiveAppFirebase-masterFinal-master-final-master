...
import com.alonsocage.componentes.managers.listeners.OnPostCreatedListener;
import com.alonsocage.componentes.managers.listeners.OnPostListChangedListener;
...
import com.alonsocage.componentes.utils.ImageUtil;
        ...
        if (uploadTask != null) {
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    LogUtil.logDebug(TAG, "imagen actualizada correctamente, url imagen: " + String.valueOf(downloadUrl));
